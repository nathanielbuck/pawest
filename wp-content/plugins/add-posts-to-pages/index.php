...
foreach($posts as $post){
	...
	if($full || $readmore){
		...
		$out .= '<'.$h.' class="main-heading main-heading--medium" style="clear: none;"><a href="' . $permalink . '">' . $title . '</a></'.$h.'>';
	...
	//If NOT full, output either the <li> or <h#> tags & the title of the post
		...
		//If images: <h#>, else: <li>
		if($img){$out .= '<'.$h.' class="main-heading main-heading--medium" style="clear: none;">';} else {$out .= '<li>';}
